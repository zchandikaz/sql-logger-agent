package info.chandika.sql.logger.agent.statement;
...
public class WrappedCallableStatement extends AbstractStatement implements CallableStatement {

    private final CallableStatement cs;
    private final String sql;

    public WrappedCallableStatement(CallableStatement cs) {
        this(cs, "N/A");
    }

    public WrappedCallableStatement(CallableStatement cs, String sql) {
        this.cs = cs;
        this.sql = sql;
    }
