...
public class WrappedPreparedStatement extends AbstractStatement implements PreparedStatement {
    ...
    public WrappedPreparedStatement(PreparedStatement ps, String sql) {
        this.ps = ps;
        this.sql = sql;
    }
